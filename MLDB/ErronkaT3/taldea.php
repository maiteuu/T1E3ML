...
if (isset($_SESSION['nombreUsuario'])) {
    ...
    <body class="body-index">
        ...
        <main>
            <form action="denboraldiaaukera.php" method="post">
                <label for="">Denboraldia:</label>
                <select name="denboraldia">
                    <option value="2024-2025">2024-2025</option>
                    <option value="2023-2024">2023-2024</option>
                </select>
                <input class="botoiak" type="submit" value="Aukeratu">
            </form>
            <?php
            $id = $_GET['id'];
            $xml = new DOMDocument;
            ...
            $xsl = new DOMDocument;
            $xsl->load("xml/taldea.xsl");
            $proc = new XSLTProcessor;
            $proc->importStyleSheet($xsl);
            $proc->setParameter("", "taldea_id", $id);
